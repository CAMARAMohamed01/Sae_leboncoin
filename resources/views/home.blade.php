...
<div class="container mx-auto px-4 mt-6">
    <div class="bg-lbc-orange/10 rounded-2xl p-8 md:p-12 text-center relative">
        ...
        <div id="home-search-bar" class="bg-white p-4 rounded-xl shadow-lg max-w-4xl mx-auto relative z-10">
    ...
    <form action="{{ route('recherche.index') }}" method="GET" class="flex flex-col md:flex-row gap-3 items-center">
        ...
        <div class="flex-1 w-full relative group"> 
            ...
            <input type="text" 
                name="localisation" 
                class="js-autocomplete-input block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:border-lbc-orange focus:ring-1 focus:ring-lbc-orange sm:text-sm transition" 
...
<div class="container mx-auto px-4 mt-12">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        @forelse($typesHebergement as $type)
            <a href="{{ route('recherche.index', ['type_hebergement' => $type->idtypehebergement]) }}" 
               class="flex flex-col items-center justify-center p-4 bg-white rounded-xl shadow-sm hover:shadow-md hover:bg-orange-50 transition cursor-pointer border border-transparent hover:border-lbc-orange/30 group">
                ...
                <span class="text-sm font-semibold text-gray-700 text-center group-hover:text-lbc-orange">
                    {{ $type->typehebergement }}
                </span>
            </a>
        @empty
            <div class="col-span-2 md:col-span-4 lg:col-span-6 flex flex-col items-center justify-center py-8 text-gray-500 bg-gray-50 rounded-xl border border-dashed border-gray-300">
                <i class="fa-regular fa-folder-open text-3xl mb-2 text-gray-400"></i>
